...
function HighTechSimulator() {
  ...
  return (
    <div className="relative w-full max-w-[340px] aspect-[9/18] mx-auto perspective-1000 group">
      <div className="relative w-full h-full bg-slate-900 rounded-[3rem] border-[10px] border-slate-800 shadow-[0_40px_80px_-15px_rgba(0,0,0,0.3)] overflow-hidden transition-transform duration-700 group-hover:rotate-y-6">
          ...
          <div className="flex-1 p-6 flex flex-col gap-6">
            ...
            {activeScreen === 0 && (
              <div className="flex-1 space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-700">
                ...
                <div className="aspect-square bg-white rounded-[2rem] shadow-xl flex items-center justify-center relative overflow-hidden border border-slate-100">
            ...
            {activeScreen === 1 && (
              <div className="flex-1 space-y-6 animate-in slide-in-from-right-8 duration-700">
                ...
                <div className="flex-1 bg-white p-6 rounded-[2rem] shadow-xl border border-slate-100 flex flex-col items-center justify-center gap-6">
            ...
            {activeScreen === 2 && (
              <div className="flex-1 space-y-6 animate-in zoom-in duration-700">
                ...
                <div className="flex-1 bg-white rounded-[2rem] border border-slate-100 p-6 flex flex-col gap-5 shadow-xl">
...
export default function LandingPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-white text-slate-950 font-body selection:bg-primary selection:text-white">
      <header className="fixed top-0 left-0 right-0 h-20 z-50 px-6 lg:px-20 flex items-center justify-between border-b border-slate-100 bg-white/80 backdrop-blur-3xl">
            ...
            <div className="grid lg:grid-cols-2 gap-20 items-center">
              <div className="space-y-10 animate-in fade-in slide-in-from-left-8 duration-1000">
                <div className="space-y-6">
                  ...
                  <h1 className="text-5xl md:text-7xl lg:text-8xl font-black leading-[0.85] font-headline uppercase italic tracking-tighter text-slate-950">
                    Smart <br /> Travel for <br /> <span className="text-primary drop-shadow-[0_0_15px_rgba(59,130,246,0.3)]">Scholars.</span>
                  </h1>
                  <p className="max-w-md text-base lg:text-lg font-bold text-slate-500 leading-relaxed border-l-8 border-primary/10 pl-8 italic">
                    The easiest way for students to get around Vizag and VZM hubs. Real-time radar, secure IDs, and simple regional boarding.
                  </p>
                </div>
                <div className="flex flex-col sm:flex-row gap-6">
                  ...
                  <Button variant="ghost" className="h-18 px-10 rounded-2xl font-black uppercase italic text-lg border border-slate-200 bg-white hover:bg-slate-50 shadow-sm transition-all">Live Map</Button>
                </div>
                <div className="flex gap-12 pt-10 border-t border-slate-200">
                   <div className="space-y-1">
                      <p className="text-2xl font-black italic text-slate-900">100%</p>
                      <p className="text-[8px] font-black uppercase text-slate-400 tracking-widest">Uptime Pulse</p>
                   </div>
                   <div className="space-y-1">
                      <p className="text-2xl font-black italic text-slate-900">20k+</p>
                      <p className="text-[8px] font-black uppercase text-slate-400 tracking-widest">Scholar Missions</p>
                   </div>
                   <div className="space-y-1">
                      <p className="text-2xl font-black italic text-slate-900">2 Hubs</p>
                      <p className="text-[8px] font-black uppercase text-slate-400 tracking-widest">Regional Coverage</p>
                   </div>
                </div>
              </div>
        ...
        <section className="py-32 bg-white">
          <div className="container mx-auto px-6 lg:px-20">
            <div className="max-w-2xl space-y-6 mb-20">
              ...
              <h2 className="text-4xl lg:text-6xl font-black uppercase italic leading-tight tracking-tighter text-slate-950">Active Shuttle Corridors.</h2>
              <p className="text-lg font-bold text-slate-400 italic">Real-time corridors connecting Vizag and VZM hubs.</p>
            </div>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-10">
              {activeRoutes?.map((route: any) => (
                <Card key={route.id} className="bg-white rounded-[3rem] p-10 border-none shadow-[0_10px_50px_rgba(0,0,0,0.03)] hover:shadow-[0_20px_80px_rgba(59,130,246,0.12)] transition-all group overflow-hidden relative border border-slate-50">
                  ...
                  <div className="flex justify-between items-start mb-8 relative z-10">
                    <div>
                      ...
                      <h4 className="text-3xl font-black italic uppercase text-slate-950 leading-none">{route.routeName}</h4>
                    </div>
                  ...
                  <div className="space-y-6 relative z-10">
                    <p className="text-[10px] font-black uppercase text-slate-400 tracking-[0.3em] flex items-center gap-2">
                       <MapPin className="h-3 w-3" /> Station Stops:
                    </p>
                  ...
                  <div className="mt-10 pt-8 border-t border-slate-50 flex justify-between items-center opacity-0 group-hover:opacity-100 transition-all translate-y-4 group-hover:translate-y-0">
                     <span className="text-[10px] font-black uppercase text-primary tracking-widest">View Map Details</span>
          ...
          <div className="container mx-auto px-6 lg:px-20 relative z-10">
            <div className="grid lg:grid-cols-2 gap-24 items-center">
              <div className="space-y-16">
                <div className="space-y-6">
                  <Badge className="bg-primary/20 text-primary border-none px-6 py-2 text-[10px] font-black uppercase tracking-[0.4em]">Operational Flow</Badge>
                  <h2 className="text-5xl lg:text-7xl font-black uppercase italic leading-[0.9] tracking-tighter">Better <br/> Commuting.</h2>
                </div>
                <div className="space-y-10">
                  {[
                    { step: "01", icon: Radar, title: "Find your Hub", desc: "Use the live radar to see available shuttles on your regional corridor." },
                    { step: "02", icon: Zap, title: "Secure a Seat", desc: "Book instantly using regional UPI. Your boarding code is issued immediately." },
                    { step: "03", icon: Fingerprint, title: "Board & Ride", desc: "Show your unique ID to the operator and track your mission in real-time." }
                  ].map((item, i) => (
                    <div key={i} className="flex gap-8 group">
                      <div className="shrink-0 h-16 w-16 bg-white rounded-2xl flex items-center justify-center text-slate-950 shadow-[0_10px_30px_rgba(255,255,255,0.1)] group-hover:bg-primary group-hover:text-white transition-all">
              ...
              <div className="relative h-[600px] lg:h-[700px] rounded-[3.5rem] overflow-hidden border-[12px] border-white/5 shadow-2xl group">
                <Image src={PlaceHolderImages.find(img => img.id === 'student-mobile')?.imageUrl || "https://picsum.photos/seed/aago-vizag-2/600/800"} fill className="object-cover transition-transform duration-1000 group-hover:scale-110" alt="Aago Scholar app" />
                <div className="absolute inset-0 bg-gradient-to-t from-primary/80 via-transparent to-transparent" />
                <div className="absolute bottom-12 left-12 right-12 space-y-4">
                  <div className="inline-flex items-center gap-3 bg-white/10 backdrop-blur-md px-4 py-1.5 rounded-full border border-white/10">
                     <Activity className="h-3 w-3 text-primary animate-pulse" />
                     <span className="text-[8px] font-black uppercase tracking-widest">Live Scholar Feed</span>
                  </div>
                  <h3 className="text-4xl lg:text-5xl font-black italic uppercase leading-none tracking-tighter">Stay Connected.</h3>
                  <p className="font-bold text-white/80 italic text-lg leading-tight">Join the network moving across the city every single day.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="py-32 bg-white">
           <div className="container mx-auto px-6 lg:px-20 text-center space-y-12">
              <div className="space-y-6 max-w-2xl mx-auto">
                 <h2 className="text-4xl lg:text-6xl font-black uppercase italic tracking-tighter text-slate-950">Join the Hub.</h2>
                 <p className="text-lg font-bold text-slate-400 italic">Start your smart commuting mission today.</p>
              </div>
              <div className="flex flex-col sm:flex-row justify-center gap-6">
                <Link href="/auth/signup">
                  <Button className="h-20 px-12 bg-slate-950 text-white rounded-[1.5rem] font-black uppercase italic text-xl shadow-2xl hover:bg-primary transition-all">New Account</Button>
                </Link>
                <Link href="/driver/signup">
                  <Button variant="outline" className="h-20 px-12 border-slate-200 text-slate-900 rounded-[1.5rem] font-black uppercase italic text-xl shadow-sm hover:border-primary hover:text-primary transition-all">Become a Driver</Button>
                </Link>
              </div>
           </div>
        </section>
        ...
        <div className="container mx-auto px-6 lg:px-20">
          <div className="flex flex-col lg:flex-row justify-between items-start gap-20">
            <div className="space-y-8">
              ...
              <p className="max-w-xs text-[10px] font-black uppercase tracking-[0.4em] text-slate-400 italic leading-loose">Modern regional transit for the scholar community. Connecting campuses across Vizag and Vizianagaram hubs.</p>
              <div className="flex gap-6">
                 {/* Social Icons Placeholder */}
                 <div className="h-10 w-10 rounded-xl bg-white border border-slate-200 flex items-center justify-center text-slate-400 hover:text-primary transition-colors cursor-pointer"><Globe className="h-5 w-5" /></div>
                 <div className="h-10 w-10 rounded-xl bg-white border border-slate-200 flex items-center justify-center text-slate-400 hover:text-primary transition-colors cursor-pointer"><Activity className="h-5 w-5" /></div>
              </div>
            </div>
            <div className="grid grid-cols-2 gap-20 lg:gap-32">
              <div className="space-y-6">
                ...
                <nav className="flex flex-col gap-4 text-sm font-bold uppercase italic text-slate-500">
                  <Link href="/auth/login" className="hover:text-primary transition-colors">Scholar Login</Link>
                  ...
                  <Link href="/admin/login" className="hover:text-primary transition-colors flex items-center gap-2"><ShieldAlert className="h-4 w-4" /> Operations Hub</Link>
                </nav>
              </div>
              <div className="space-y-6">
                <p className="text-[10px] font-black uppercase tracking-widest text-slate-900">Network Info</p>
                <nav className="flex flex-col gap-4 text-sm font-bold uppercase italic text-slate-500">
          ...
          <div className="mt-20 pt-10 border-t border-slate-200 flex flex-col lg:flex-row justify-between items-center gap-6">
