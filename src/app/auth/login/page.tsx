...
export default function LoginPage() {
  ...
  const handleSendOtp = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({ 
        variant: "destructive", 
        title: "OTP Failed", 
        description: "Check your internet or phone number and try again." 
      });
    } finally {
      setLoading(false);
    }
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-background p-6 font-body safe-area-inset">
      ...
      <Card className="w-full max-md bg-white/5 border-none rounded-[3rem] overflow-hidden shadow-2xl">
